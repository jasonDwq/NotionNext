...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个运营苦命人, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小“职能”阿段', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '关于发布AI 运营内容的小网站，喜欢记得点个收藏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.daminyc.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小职能阿段, 博客,AI ,智能, 小飞机,  ', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jasonduan71@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.daminyc.xyz', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6GpyEuRcDsXUVvErE7emtF1kyAx56aWXpuA&usqp=CAU', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '蜀ICP备14022222号-2', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/#/song?id=27907997.mp3',
      cover:
  ...
  // 网站图片
  IMG_LAZY_LOAD_PLACEHOLDER: process.env.NEXT_PUBLIC_IMG_LAZY_LOAD_PLACEHOLDER || 'https://www.google.com.hk/imgres?imgurl=https%3A%2F%2Fimageio.forbes.com%2Fspecials-images%2Fimageserve%2F64213c10fc7ed6f0a3eb47ae%2FThe-Intersection-Of-AI-And-Human-Creativity--Can-Machines-Really-Be-Creative-%2F960x0.jpg%3Fheight%3D473%26width%3D711%26fit%3Dbounds&tbnid=ihU9YclhzASzEM&vet=12ahUKEwiv4PfcqbmBAxXGMkQIHT7cB8gQMygoegUIARCbAQ..i&imgrefurl=https%3A%2F%2Fwww.forbes.com%2Fsites%2Fbernardmarr%2F2023%2F03%2F27%2Fthe-intersection-of-ai-and-human-creativity-can-machines-really-be-creative%2F&docid=LpyooECE0-oUUM&w=710&h=473&q=AI%E5%9B%BE%E7%89%87&ved=2ahUKEwiv4PfcqbmBAxXGMkQIHT7cB8gQMygoegUIARCbAQ', // 懒加载占位图片地址，支持base64或url
